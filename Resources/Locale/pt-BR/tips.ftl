...
tips-dataset-38 = As a Traitor, phoron gas is an excellent way to create chaos. It can be ignited to make an area extra-uninhabitable, and can cause toxin damage to those that inhale it.
...
tips-dataset-40 = As a Traitor, have you tried injecting phoron into batteries? In the case of a defibrillator, it explodes on use; hurting the user and the patient!
...
tips-dataset-74 = As an Engineer, you can use phoron glass to reinforce an area and prevent radiation. Uranium glass can also be used to prevent radiation.
...
tips-dataset-98 = You can make spears with reinforced glass, phoron glass, or uranium glass shards to enhance their damage.
